...
class PositionElement : NSObject, NSCoding{

    var accuracy : Int!
    var address : String!
    var altitude : Int!
    var attributes : PositionAttribute!
    var course : Int!
    var deviceId : Int!
    ...
    init(fromJson json: JSON!){
        ...
        if !attributesJson.isEmpty{
            attributes = PositionAttribute(fromJson: attributesJson)
        }
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        attributes = aDecoder.decodeObject(forKey: "attributes") as? PositionAttribute
...
class PositionAttribute : NSObject, NSCoding{
