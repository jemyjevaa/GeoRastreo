...
class MenuEmpresasViewModel{
    private let service: MenuEmpresaServiceProtocol
    ...
    init(withAuthentication serviceProtocol: MenuEmpresaServiceProtocol = MenuEmpresaService()) {
