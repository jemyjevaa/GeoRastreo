...
import UIKit
import PanModal
class AlertaPeriodosViajes: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("cantidad unidades ",self.periodoData.count)
...
extension AlertaPeriodosViajes: UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate{
...
extension AlertaPeriodosViajes: PanModalPresentable {
